...
export default function Footer() {
  return (
    <footer className="site-footer bg-[#f5f9ff] py-10 sm:py-12 md:py-16 px-4 sm:px-5 md:px-[5%]">
      <div className="container max-w-[1280px] mx-auto">
        <div className="footer-grid grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-start mb-8 sm:mb-10 md:mb-12">
          <div className="footer-left">
            <div className="footer-card bg-[#FDFEFF] rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 border border-[rgba(18,52,91,0.06)] shadow-[0_4px_12px_rgba(0,0,0,0.04)]">
              <h4 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#1c76e4] mb-2">AAA ortho clinic</h4>
              <p className="text-xs sm:text-sm md:text-[15px] text-[#1c76e4] mb-3 sm:mb-4 tracking-wide">BONE | JOINT | SPINE | FRACTURE | ARTHRITIS</p>
              <p className="text-sm sm:text-[15px] text-[#6b7f99] mb-6 sm:mb-8 leading-relaxed max-w-[480px]">
                DELIVERING ADVANCED ORTHOPEDIC CARE TO PATTUKKOTTAI AND SURROUNDING AREAS.
              </p>
              
              <div className="contact flex items-center gap-2.5 sm:gap-3 mb-2.5 sm:mb-3">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="text-[#1c76e4] shrink-0">
                ...
                <a href="tel:+918220776119" className="text-[#1c76e4] no-underline font-medium hover:underline text-sm sm:text-[15px]">
                  82 20 77 61 19
                </a>
              </div>
              <div className="contact flex items-center gap-2.5 sm:gap-3 mb-6 sm:mb-8 md:mb-10">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="text-[#1c76e4] shrink-0">
                  <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" fill="currentColor"/>
                </svg>
                <a href="mailto:aaaorthoclinic@gmail.com" className="text-[#1c76e4] no-underline font-medium hover:underline text-sm sm:text-[15px] break-all">
                  aaaorthoclinic@gmail.com
                </a>
              </div>

              <div className="footer-info-box bg-[#FDFEFF] rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 m-0 border border-[rgba(18,52,91,0.06)] flex flex-col sm:flex-row gap-4 sm:gap-6 items-stretch sm:items-center shadow-[0_4px_12px_rgba(0,0,0,0.04)]">
          ...
          <div className="footer-right">
            <div className="relative">
              <iframe 
                ...
                className="map w-full rounded-xl shadow-sm h-[300px] sm:h-[350px] md:h-[450px]"
        ...
        <div className="site-bottom flex flex-col md:flex-row justify-center items-center pt-5 sm:pt-6 border-t border-[#d4e4f7] text-xs sm:text-[13px] text-[#6b7f99] gap-2 sm:gap-1 text-center">
